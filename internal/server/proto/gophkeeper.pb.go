...
var file_gophkeeper_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x61, 0x32, 0x91, 0x05, 0x0a, 0x0a, 0x47, 0x6f, 0x70, 0x68, 0x6b, 0x65, 0x65, 0x70,
	0x65, 0x72, 0x12, 0x51, 0x0a, 0x14, 0x48, 0x61, 0x6e, 0x64, 0x6c, 0x65, 0x41, 0x75, 0x74, 0x68,
	...
	0x4e, 0x6f, 0x64, 0x65, 0x54, 0x65, 0x78, 0x74, 0x12, 0x17, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47,
	0x65, 0x74, 0x4e, 0x6f, 0x64, 0x65, 0x54, 0x65, 0x78, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x18, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x4e, 0x6f, 0x64, 0x65, 0x54,
	0x65, 0x78, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x33, 0x0a,
...
var file_gophkeeper_proto_msgTypes = make([]protoimpl.MessageInfo, 23)
...
var file_gophkeeper_proto_depIdxs = []int32{
	23, // 0: api.Token.createdAt:type_name -> google.protobuf.Timestamp
	23, // 1: api.Token.endDateAt:type_name -> google.protobuf.Timestamp
	23, // 2: api.User.createdAt:type_name -> google.protobuf.Timestamp
	23, // 3: api.User.updatedAt:type_name -> google.protobuf.Timestamp
	23, // 4: api.User.deletedAt:type_name -> google.protobuf.Timestamp
	...
	23, // 7: api.Text.createdAt:type_name -> google.protobuf.Timestamp
	23, // 8: api.Text.updatedAt:type_name -> google.protobuf.Timestamp
	23, // 9: api.Text.deletedAt:type_name -> google.protobuf.Timestamp
	...
	23, // 16: api.Metadata.createdAt:type_name -> google.protobuf.Timestamp
	23, // 17: api.Metadata.updatedAt:type_name -> google.protobuf.Timestamp
	23, // 18: api.Metadata.deletedAt:type_name -> google.protobuf.Timestamp
	23, // 19: api.Card.createdAt:type_name -> google.protobuf.Timestamp
	23, // 20: api.Card.updatedAt:type_name -> google.protobuf.Timestamp
	23, // 21: api.Card.deletedAt:type_name -> google.protobuf.Timestamp
	...
	11, // 28: api.Gophkeeper.HandleCreateText:input_type -> api.CreateTextRequest
	15, // 29: api.Gophkeeper.HandleGetListText:input_type -> api.GetListTextRequest
	13, // 30: api.Gophkeeper.HandleGetNodeText:input_type -> api.GetNodeTextRequest
	0,  // 31: api.Gophkeeper.HandlePing:input_type -> api.PingRequest
	8,  // 32: api.Gophkeeper.HandleUserExist:input_type -> api.UserExistRequest
	19, // 33: api.Gophkeeper.HandleCreateCard:input_type -> api.CreateCardRequest
	21, // 34: api.Gophkeeper.HandleGetNodeCard:input_type -> api.GetNodeCardRequest
	5,  // 35: api.Gophkeeper.HandleAuthentication:output_type -> api.AuthenticationResponse
	7,  // 36: api.Gophkeeper.HandleRegistration:output_type -> api.RegistrationResponse
	12, // 37: api.Gophkeeper.HandleCreateText:output_type -> api.CreateTextResponse
	16, // 38: api.Gophkeeper.HandleGetListText:output_type -> api.GetListTextResponse
	14, // 39: api.Gophkeeper.HandleGetNodeText:output_type -> api.GetNodeTextResponse
	1,  // 40: api.Gophkeeper.HandlePing:output_type -> api.PingResponse
	9,  // 41: api.Gophkeeper.HandleUserExist:output_type -> api.UserExistResponse
	20, // 42: api.Gophkeeper.HandleCreateCard:output_type -> api.CreateCardResponse
	22, // 43: api.Gophkeeper.HandleGetNodeCard:output_type -> api.GetNodeCardResponse
